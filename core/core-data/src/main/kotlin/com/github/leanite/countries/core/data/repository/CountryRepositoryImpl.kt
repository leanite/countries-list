...
internal class CountryRepositoryImpl @Inject constructor(
    ...
    override suspend fun getCountries(): AppResult<List<Country>> = withContext(Dispatchers.IO){
    ...
    override suspend fun getCountry(code: String): AppResult<Country> = withContext(Dispatchers.IO){
    ...
    override suspend fun getCountryDetails(code: String): AppResult<CountryDetails> {
